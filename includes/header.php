                        ...
                        <?php else: ?>
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?php echo $prefix; ?>user/page_inbox.php"
                                    class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 <?php echo basename($_SERVER['PHP_SELF']) == 'page_inbox.php' ? 'text-indigo-400' : 'text-gray-300'; ?> hover:bg-gray-800"><?php echo __('manage_messages'); ?></a>
                                <a href="<?php echo $prefix; ?>user/create_campaign.php"
                                    class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 <?php echo basename($_SERVER['PHP_SELF']) == 'create_campaign.php' ? 'text-indigo-400' : 'text-gray-300'; ?> hover:bg-gray-800"><?php echo __('setup_campaign'); ?></a>
