    ...
    <nav class="space-y-2" x-data="{ 
        ...
        <div class="space-y-1">
            <button @click="accountsOpen = !accountsOpen"
                ...
                <div class="flex items-center gap-3">
                    <svg class="w-5 h-5 text-gray-500 group-hover:text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    <span><?php echo __('accounts_management'); ?></span>
                </div>
                <svg class="w-4 h-4 transition-transform duration-200" :class="accountsOpen ? 'rotate-180' : ''" fill="none"
        ...
        <div class="space-y-1">
            <button @click="systemOpen = !systemOpen"
                ...
                <svg class="w-4 h-4 transition-transform duration-200" :class="systemOpen ? 'rotate-180' : ''" fill="none"
                    stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                </svg>
            </button>
        ...
        <div class="pt-4 mt-4 border-t border-gray-800">
            <a href="../logout.php"
                ...
                <svg class="w-5 h-5 text-red-500/50 group-hover:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
