...
<div id="main-user-container" class="main-user-container flex min-h-screen bg-gray-900 font-sans"
    ...
    <main class="flex-1 flex flex-col bg-gray-900/50 backdrop-blur-md relative p-6">
        ...
        <div class="flex-none mb-8">
            <!-- Page Selector -->
            <div
                class="glass-panel p-4 md:p-6 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl hover:border-indigo-500/20 transition-all shadow-xl max-w-2xl">
                ...
                <div class="sticky top-24 space-y-6">
                    <div
                        ...
                        <div class="p-4 bg-[#18191a] h-[480px] flex flex-col font-sans">
                            ...
                            <!-- Summary Hint -->
                            <div class="bg-indigo-600/5 rounded-2xl border border-indigo-500/10 p-4 text-center mt-4">
        ...
        <div class="lg:col-span-8 order-1 lg:order-2" x-show="selectedPageId">
            <div
                class="glass-panel p-4 md:p-8 rounded-[2rem] border border-white/10 bg-gray-800/40 backdrop-blur-2xl hover:border-indigo-500/30 transition-all shadow-2xl relative overflow-hidden group">
            ...
            <template x-for="log in logs" :key="log.id">
                <div class="p-4 bg-black/40 rounded-2xl border border-white/5 flex items-center justify-between group">
                    <div class="flex items-center gap-4 min-w-0">
                        <div class="w-10 h-10 rounded-xl bg-indigo-500/10 flex-shrink-0 flex items-center justify-center font-bold text-indigo-400"
                    ...
                    <div
                        ...
                        <template x-if="log.comment_id">
                            <a :href="log.platform === 'instagram' ? 'https://business.facebook.com/latest/inbox/all?selected_item_id=' + log.comment_id : 'https://facebook.com/' + (log.comment_id.includes('_') ? log.comment_id : log.page_id + '_' + log.comment_id)"
                                target="_blank" class="p-2 text-gray-400 hover:text-indigo-400 transition-colors"
    ...
    function autoModerator() {
        return {
            ...
            init() {
                ...
                this.loadLogs(); // Initial load for global logs if no page selected
