                            ...
                            <div class="pt-8 border-t border-white/5 space-y-6">
                                ...
                                <?php for ($i = 1; $i <= 3; $i++): ?>
                                    <div class="p-6 bg-white/5 rounded-2xl border border-white/5 space-y-4">
                                        <h5 class="text-xs font-black text-gray-500 uppercase tracking-widest">Feature #<?php echo $i; ?></h5>
                                        <div class="grid md:grid-cols-2 gap-6">
                                            <!-- AR -->
                                            <div class="space-y-3">
                                                <div>
                                                    <label class="block text-gray-600 text-[10px] uppercase font-bold mb-1">العنوان (AR)</label>
                                                    <input type="text" name="tool_f<?php echo $i; ?>_t_ar" value="<?php echo htmlspecialchars($settings['tool_f' . $i . '_t_ar'] ?? __('tool_feature_' . $i)); ?>" class="setting-input text-sm">
                                                </div>
                                                <div>
                                                    <label class="block text-gray-600 text-[10px] uppercase font-bold mb-1">الوصف (AR)</label>
                                                    <textarea name="tool_f<?php echo $i; ?>_d_ar" rows="2" class="setting-input text-sm"><?php echo htmlspecialchars($settings['tool_f' . $i . '_d_ar'] ?? __('tool_feature_' . $i . '_desc')); ?></textarea>
                                                </div>
                                            </div>
                                            <!-- EN -->
                                            <div class="space-y-3">
                                                <div>
                                                    <label class="block text-gray-600 text-[10px] uppercase font-bold mb-1">Title (EN)</label>
                                                    <input type="text" name="tool_f<?php echo $i; ?>_t_en" value="<?php echo htmlspecialchars($settings['tool_f' . $i . '_t_en'] ?? ''); ?>" class="setting-input text-sm">
                                                </div>
                                                <div>
                                                    <label class="block text-gray-600 text-[10px] uppercase font-bold mb-1">Description (EN)</label>
                                                    <textarea name="tool_f<?php echo $i; ?>_d_en" rows="2" class="setting-input text-sm"><?php echo htmlspecialchars($settings['tool_f' . $i . '_d_en'] ?? ''); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
