...
<div class="flex min-h-screen pt-4">
    ...
    <div class="flex-1 min-w-0 p-4 md:p-8">
        ...
        <form method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <!-- Header Settings Tab -->
            <div id="header-tab" class="tab-content hidden space-y-6">
                <div class="glass-card p-6 md:p-8 rounded-2xl border border-white/5">
                    <h3 class="text-lg font-bold text-white mb-6 flex items-center">
                        <span class="w-2 h-6 bg-indigo-500 rounded-full mr-3"></span>
                        <?php echo __('header_settings'); ?>
                    </h3>
            ...
            <div id="ai_settings-tab" class="tab-content hidden space-y-6">
                <div class="glass-card p-6 md:p-8 rounded-2xl border border-white/5">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="p-4 bg-white/5 rounded-xl border border-white/5">
                            <h4
                                class="text-indigo-400 font-bold mb-4 border-b border-indigo-500/20 pb-2 flex items-center gap-2">
                        ...
                        <div class="p-4 bg-white/5 rounded-xl border border-white/5">
                            <h4
                                class="text-green-400 font-bold mb-4 border-b border-green-500/20 pb-2 flex items-center gap-2">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                                        d="M22.2819 9.8211a5.9847 5.9847 0 0 0-.5157-4.9108 6.0462 6.0462 0 0 0-6.5098-2.9A6.0651 6.0651 0 0 0 4.9807 4.1818a5.9847 5.9847 0 0 0-3.9977 2.9 6.0462 6.0462 0 0 0 .7427 7.0966 5.98 5.98 0 0 0 .511 4.9107 6.051 6.051 0 0 0 6.5146 2.9001A5.9847 5.9847 0 0 0 13.2599 24a6.0557 6.0557 0 0 0 5.7718-4.2058 5.9894 5.9894 0 0 0 3.9977-2.9001 6.0557 6.0557 0 0 0-.7475-7.0729zm-9.022 12.6081a4.4755 4.4755 0 0 1-2.8764-1.0408l.1419-.0804 4.7783-2.7582a.7948.7948 0 0 0 .3927-.6813v-6.7369l2.02 1.1686a.071.071 0 0 1 .038.052v5.5826a4.504 4.504 0 0 1-4.4945 4.4944zm-9.6607-4.1254a4.4708 4.4708 0 0 1-.5346-3.0137l.142.0852 4.783 2.7582a.7712.7712 0 0 0 .7806 0l5.8428-3.3685v2.3324a.0804.0804 0 0 1-.0332.0615L9.74 19.9502a4.4992 4.4992 0 0 1-6.1408-1.6464zM2.3408 7.8956a4.485 4.485 0 0 1 2.3655-1.9728V11.6a.7664.7664 0 0 0 .3879.6765l5.8144 3.3543-2.0201 1.1685a.0757.0757 0 0 1-.071 0l-4.8303-2.7865A4.504 4.504 0 0 1 2.3408 7.872zm16.5963 3.8558L13.1038 8.364 15.1195 7.2a.0757.0757 0 0 1 .071 0l4.8303 2.7913a4.4944 4.4944 0 0 1-.6765 8.1042v-5.6772a.79.79 0 0 0-.4078-.667zm2.0107-3.0231l-.142-.0852-4.7735-2.7818a.7759.7759 0 0 0-.7854 0L9.409 9.2298V6.8974a.0662.0662 0 0 1 .0284-.0615l4.8303-2.7866a4.4992 4.4992 0 0 1 6.6802 4.66zM8.3065 12.863l-2.02-1.1638a.0804.0804 0 0 1-.038-.0567V6.0742a4.4992 4.4992 0 0 1 7.3757-3.4537l-.142.0805L8.704 5.459a.7948.7948 0 0 0-.3927.6813zm1.0916-2.3229l3.865 2.2276 3.8651-2.2276V8.3023l-3.8651-2.2275-3.865 2.2275z" />
                                </svg>
                                OpenAI (ChatGPT)
                            </h4>
                            <div class="grid md:grid-cols-2 gap-4">
                                <div>
                                    <label
                                        class="block text-gray-400 text-sm font-medium mb-2"><?php echo __('openai_api_key'); ?></label>
                                    <input type="text" name="openai_api_key"
                                        value="<?php echo htmlspecialchars($settings['openai_api_key'] ?? ''); ?>"
                                        class="setting-input" placeholder="sk-...">
                                    <p class="text-[10px] text-gray-500 mt-1">
                                        <?php echo __('openai_api_key_desc'); ?>
                                    </p>
                                </div>
                                <div>
                                    <label
                                        class="block text-gray-400 text-sm font-medium mb-2"><?php echo __('openai_model'); ?></label>
                                    <select name="openai_model" class="setting-input">
                                        ...
                                        <option value="gpt-4o" <?php echo ($settings['openai_model'] ?? '') == 'gpt-4o' ? 'selected' : ''; ?>>GPT-4o</option>
                                    </select>
                                    <p class="text-[10px] text-gray-500 mt-1">
                                        <?php echo __('openai_model_desc'); ?>
                                    </p>
                                </div>
                            </div>
                        </div>
