                        ...
                        <div
                            ...
                            <div class="p-4 bg-black/40 h-[500px] flex flex-col">
                                <div class="flex flex-col items-center mb-6 mt-4">
                                    <div
                                        class="w-14 h-14 rounded-full bg-[#1877F2] border-2 border-white/10 mb-2 flex items-center justify-center text-white shadow-lg text-2xl font-bold overflow-hidden">
                                        <?php if (isset($page['page_name'])): ?>
                                            <span><?php echo strtoupper(mb_substr($page['page_name'], 0, 1)); ?></span>
                                        <?php else: ?>
                                    ...
                                    <div class="font-bold text-white text-sm">
                                        <?php echo isset($page['page_name']) ? htmlspecialchars($page['page_name']) : 'Marketation - ماركتيشن'; ?>
                                    </div>
