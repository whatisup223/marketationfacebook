                    ...
                    <div class="space-y-2 py-6">
                        ...
                        <?php else: ?>
                            ...
                            <?php else: ?>
                                ...
                                <div x-data="{ mFbOpen: <?php echo in_array(basename($_SERVER['PHP_SELF']), ['fb_accounts.php', 'page_inbox.php', 'create_campaign.php', 'campaign_reports.php']) ? 'true' : 'false'; ?> }">
                                    <button @click="mFbOpen = !mFbOpen" class="-mx-3 w-full flex items-center justify-between rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-300 hover:bg-gray-800">
                                        <div class="flex items-center gap-2">
                                            <svg class="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                                            <span><?php echo __('facebook'); ?></span>
                                        </div>
                                        <svg class="w-4 h-4 transition-transform duration-200" :class="mFbOpen ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                                    </button>
                                ...
                                <div x-data="{ mWaOpen: false }">
                                    <button @click="mWaOpen = !mWaOpen" class="-mx-3 w-full flex items-center justify-between rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-300 hover:bg-gray-800">
                                        <div class="flex items-center gap-2">
                                        ...
                                        <svg class="w-4 h-4 transition-transform duration-200" :class="mWaOpen ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                                    </button>
                                    <div x-show="mWaOpen" x-transition class="pl-4 rtl:pr-4">
                                        <p class="px-3 py-2 text-xs text-gray-500 italic"><?php echo __('coming_soon') ?? 'Soon...'; ?></p>
                                    </div>
                                </div>
