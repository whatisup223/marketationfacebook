                    ...
                    <div class="grid lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-1 space-y-4">
                            ...
                            <div class="relative group">
                                ...
                                $h_img_url = !empty($h_img) ? '../uploads/' . $h_img : 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=400';
                                ?>
                                <div
            ...
            <div id="tool-tab" class="tab-content hidden space-y-6">
                <div class="glass-card p-6 md:p-8 rounded-2xl border border-white/5">
                    ...
                    <div class="grid lg:grid-cols-3 gap-8">
                        <!-- Image Upload -->
                        <div class="lg:col-span-1 space-y-4">
                            <label class="block text-gray-400 text-sm font-medium"><?php echo __('tool_image'); ?></label>
                            <div class="relative group aspect-video bg-gray-900 rounded-2xl border border-white/10 overflow-hidden flex items-center justify-center">
                                <?php
                                $t_img = $settings['tool_image'] ?? '';
                                $t_img_url = !empty($t_img) ? '../uploads/' . $t_img : '../assets/img/platform-mockup.png';
                                ?>
                                <img id="tool_image_preview" src="<?php echo $t_img_url; ?>" class="w-full h-full object-cover">
                                
                                <?php if (!empty($t_img)): ?>
                                        <button type="submit" name="delete_tool_image" class="absolute top-4 right-4 p-2 bg-red-600 rounded-xl text-white shadow-xl hover:bg-red-500 transition-all opacity-0 group-hover:opacity-100">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                                        </button>
                                <?php endif; ?>

                                <!-- Loader -->
                                <div id="tool_upload_loader" class="absolute inset-0 bg-slate-950/60 backdrop-blur-sm hidden flex items-center justify-center z-10">
                                    <div class="w-10 h-10 border-4 border-blue-500 border-t-transparent rounded-full animate-spin"></div>
                                </div>
                            </div>
                            <input type="file" name="tool_image" id="tool_image_input" class="setting-input text-xs" accept="image/*">
                        </div>
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            <div class="grid md:grid-cols-2 gap-6">
                                <!-- Arabic -->
                                <div class="space-y-4">
                                    <h4 class="text-xs font-black text-blue-400 uppercase tracking-widest flex items-center gap-2">
                                        <span class="w-1 h-1 rounded-full bg-blue-500"></span> Arabic Content
                                    </h4>
                                    <div>
                                        <label class="block text-gray-500 text-[10px] uppercase font-bold mb-1"><?php echo __('tool_badge_ar'); ?></label>
                                        <input type="text" name="tool_badge_ar" value="<?php echo htmlspecialchars($settings['tool_badge_ar'] ?? __('extraction_tools')); ?>" class="setting-input">
                                    </div>
                                    <div>
                                        <label class="block text-gray-500 text-[10px] uppercase font-bold mb-1"><?php echo __('tool_title_ar'); ?></label>
                                        <input type="text" name="tool_title_ar" value="<?php echo htmlspecialchars($settings['tool_title_ar'] ?? __('tool_showcase_title')); ?>" class="setting-input font-bold">
                                    </div>
                                    <div>
                                        <label class="block text-gray-500 text-[10px] uppercase font-bold mb-1"><?php echo __('tool_subtitle_ar'); ?></label>
                                        <textarea name="tool_subtitle_ar" rows="3" class="setting-input text-sm"><?php echo htmlspecialchars($settings['tool_subtitle_ar'] ?? __('tool_showcase_subtitle')); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        <label class="block text-gray-500 text-[10px] uppercase font-bold mb-1"><?php echo __('tool_badge_en'); ?></label>
                                        <input type="text" name="tool_badge_en" value="<?php echo htmlspecialchars($settings['tool_badge_en'] ?? 'Extraction Tools'); ?>" class="setting-input">
                                    </div>
                                    <div>
                                        <label class="block text-gray-500 text-[10px] uppercase font-bold mb-1"><?php echo __('tool_title_en'); ?></label>
                                        <input type="text" name="tool_title_en" value="<?php echo htmlspecialchars($settings['tool_title_en'] ?? 'The Power of Extraction'); ?>" class="setting-input font-bold">
                                    </div>
                                    <div>
                                        <label class="block text-gray-500 text-[10px] uppercase font-bold mb-1"><?php echo __('tool_subtitle_en'); ?></label>
                                        <textarea name="tool_subtitle_en" rows="3" class="setting-input text-sm"><?php echo htmlspecialchars($settings['tool_subtitle_en'] ?? ''); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pt-6 border-t border-white/5 grid md:grid-cols-3 gap-4">
                                <div>
                                    <label class="block text-gray-500 text-[10px] uppercase font-bold mb-1"><?php echo __('tool_btn_text_ar'); ?></label>
                                    <input type="text" name="tool_btn_text_ar" value="<?php echo htmlspecialchars($settings['tool_btn_text_ar'] ?? ''); ?>" class="setting-input text-sm" placeholder="مثلاً: ابدأ الآن">
                                </div>
                                <div>
                                    <label class="block text-gray-500 text-[10px] uppercase font-bold mb-1"><?php echo __('tool_btn_text_en'); ?></label>
                                    <input type="text" name="tool_btn_text_en" value="<?php echo htmlspecialchars($settings['tool_btn_text_en'] ?? ''); ?>" class="setting-input text-sm" placeholder="e.g. Start Now">
                                </div>
                                <div>
                                    <label class="block text-gray-500 text-[10px] uppercase font-bold mb-1"><?php echo __('tool_btn_url'); ?></label>
                                    <input type="text" name="tool_btn_url" value="<?php echo htmlspecialchars($settings['tool_btn_url'] ?? ''); ?>" class="setting-input text-sm" placeholder="#register">
                                </div>
                            </div>
                        </div>
                    </div>
